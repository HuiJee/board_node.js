...
const { getPosts, getPostById, createPost, createForm, editForm, updatePost, deletePost } = require('../controller/postController');
...
router.get('/:id/edit', editForm);    // 게시글 수정 페이지
